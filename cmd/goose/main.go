...
Examples:
    ...
    goose vertica "vertica://user:password@127.0.0.1:5433/dbname?use_prepared_statements=0" status
    ...
    GOOSE_DRIVER=vertica GOOSE_DBSTRING="vertica://user:password@127.0.0.1:5433/dbname?use_prepared_statements=0" goose status
